...
// Fetch rejected logs with optional student filter
$query = "
            ...
            <header class="header-container">
                <div class="rejected-page">
                    <div class="header-left">
                        <h2><i class="fa-solid fa-thumbs-down"></i> 
                            <?php echo $student_id_filter ? "Rejected Duty Logs for Student $student_id_filter" : "Rejected Duty Logs"; ?>
                        </h2>
                    </div>
                </div>
                    ...
                    <div class="search-sort-container">
                        ...
                        <form method="GET" class="student-filter">
                            ...
                            <?php if ($student_id_filter): ?>
                                <a href="rejected_duties.php">Show All Rejected</a>
                            <?php endif; ?>
                        </form>
                ...
                <div class="table-content">
                    <table id="studentsTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="9">No rejected duty logs found.</td>
                            </tr>
                            <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td data-label="Hours Worked">
                                    <?php echo ($log['status'] === 'Rejected') ? 'N/A' : htmlspecialchars($log['hours_worked']); ?>
                                </td>
                                <td data-label="Status" class="status-rejected">
                                    <?php 
                                    if ($log['status'] == 'Rejected') {
                                        echo '<i class="fa-solid fa-times-circle"></i> ';
                                    }
