...
<head>
    ...
    <script>
    function submitForm() {
        let studentId = document.getElementById("studentSelect").value || document.getElementById("studentIdInput").value;
    ...
    function printReport() {
        ...
        if (studentId) {
            ...
            alert("Please select or enter a student ID first.");
        }
    }
    </script>
</head>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <header class="header-container">
                ...
                <div class="header-right">
                    <div class="search-sort-container">
                        ...
                        <!-- Add student ID input without changing design -->
                        <form method="GET" style="display: inline;">
                            <input type="text" id="studentIdInput" name="student_id" placeholder="Enter Student ID" 
                                   value="<?php echo htmlspecialchars($student_id ?? ''); ?>"
                                   style="margin-left: 10px; padding: 5px;">
                            <button type="submit" style="padding: 5px 10px;" onclick="submitForm()">View</button>
                        </form>
            ...
            <div class="student-info-container">
                ...
                <p><strong>Course:</strong> <span class="student-course"><?= htmlspecialchars($student_course) ?></span></p>
                <p><strong>Department:</strong> <span
                        class="student-department"><?= htmlspecialchars($student_department) ?></span></p>
                <p><strong>Year Level:</strong> <span class="student-year"><?= htmlspecialchars($student_year) ?></span></p>
