            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="approve_duty.php"
                        class="<?php echo ($current_page == 'approve_duty.php') ? 'active' : ''; ?>">
                        <i class="fas fa-tasks"></i>Verify Duty Logs
                    </a>
                </li>
                <li>
                    <a href="student_profiles.php"
                        class="<?php echo ($current_page == 'student_profiles.php') ? 'active' : ''; ?>">
                        <i class='fas fa-users'></i>Student Profiles
                    </a>
                </li>
                <li>
                    <a href="export_report.php"
                        class="<?php echo ($current_page == 'export_report.php') ? 'active' : ''; ?>">
