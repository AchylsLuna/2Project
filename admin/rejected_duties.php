...
<body>
            ...
            <section class="table-container">
                <div class="table-content">
                    <table id="rejectedDutiesTable">
                        ...
                        <tbody>
                            <?php if (empty($rejectedDuties)): ?>
                                <tr><td colspan="9">No rejected duty logs found.</td></tr>
                            <?php else: ?>
    ...
    <script>
        ...
        document.getElementById('searchInput').addEventListener('keyup', function() {
            ...
            const table = document.getElementById('rejectedDutiesTable');
